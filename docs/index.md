...
??? info "==**📅 2025 г.**== Переключение внимания на разработку по Большой Одессе для **ПЛС Черноморска**  "
    ...
    1. **ПЛС Черноморск / Дунай ► Пакетная обрезка фото квитанций перед формированием PDF для АМПУ**
    2. [Инструкция : Пакетная обрезка фото квитанций • v.1.0](reports/instr_video_09_packet_photo_crop.md)
